  ...
  return (
    <div className={styles.container} id="two">
      ...
      <div className={styles.Group875}> 
        <Image src="/img/Group 875.png" alt='' layout='fill' objectFit='fill' />
      </div>
      <div className={styles.Group874}>
        <Image src="/img/Group 874.png" alt='' layout='fill' objectFit='fill' />
      </div>
      <div className={styles.Vector36}>
        <Image src="/img/Vector 36.png" alt='' layout='fill' objectFit='fill' />
      </div>
      <div className={styles.Ellipse47}>
        <Image src="/img/Ellipse 47.png" alt='' layout='fill' objectFit='fill' />
      </div>
    </div>
  )
}
